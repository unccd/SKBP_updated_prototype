...
unccdApp.config(['$translateProvider', function ($translateProvider) {
    $translateProvider.translations('en', {
        ...
        'postcop_nav':'Postcop',
        'WOCATBPtype_nav':'WOCAT Best Practice type',
        'UNCCDBP_nav': 'UNCCD Best Practice'
    });
...
// Filter for decoding html entities in solr responses 
unccdApp.filter('trusted', ['$sce', function($sce){

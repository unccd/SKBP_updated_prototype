...
@echo                   results in: -Xms4g -Xmx4g; by default, this script sets the heap size to 
@echo                   -Xms1024m and -Xms4096m 
@echo.
...
IF "%SOLR_JAVA_MEM%"=="" set SOLR_JAVA_MEM=-Xms2048m -Xmx4096m
